...
def parse_arguments(is_training: bool = True):
    ...
    parser.add_argument("--hflip", type=float, default=0, help="_")
    parser.add_argument("--gblur", type=float, default=0, help="_")
    parser.add_argument("--rgrayscale", type=float, default=0, help="_")
    parser.add_argument("--rerasing", type=float, default=0, help="_")
